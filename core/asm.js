...
asm.draw = function(context, transform, data) {
  ...
  asm.drawtype( context, path, data, 'marsh', 'rgba(  55, 140, 135, 0.88)', true )
  asm.drawtype( context, path, data, 'grass', 'rgba(  65, 150,  65, 0.85)', true )
  ...
  asm.drawtype( context, path, data, 'lowmt', 'rgba( 130, 100,  70, 0.65)', true )
